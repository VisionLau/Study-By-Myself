...
public class ReTestQueue {
    public static void main(String[] args){
        // ArrayQueue arrayQueue=new ArrayQueue(3);
        //CircleQueue arrayQueue=new CircleQueue(3);
        ReArrayQueue arrayQueue=new ReArrayQueue(3);
        ...
        while (flag){
            ...
            switch (input){
                case "a":
                    ...
                    arrayQueue.addQueueEle(num);
                    break;
                case "g":
                    try{
                        int  ele=arrayQueue.getQueueEle();
                ...
                case "h":
                    try{
                        System.out.println("队列头为："+arrayQueue.getQueueHead());
                    }catch (RuntimeException e){
                        System.out.println(e.getMessage());
                    }
                    break;
